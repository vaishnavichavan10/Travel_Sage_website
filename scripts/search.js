...
const api_key = `IzaSyBesHYCw4GEI2cC1Pu7sMdf3d6cFblDZeE`;
...
async function searchNow(){
    ...
    let res = await fetch(`https://youtube.googleapis.com/youtube/v3/search?part=snippet&maxResults=5&q=${val}&key=${api_key}`);
