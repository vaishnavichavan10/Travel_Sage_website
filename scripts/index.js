...
const api_key = `AIzaSyBesHYCw4GEI2cC1Pu7sMdf3d6cFblDZeE`;
let urlSearch = `https://youtube.googleapis.com/youtube/v3/search?part=snippet&maxResults=20&q=java&key=${api_key}`;

let urlPopular = `https://youtube.googleapis.com/youtube/v3/videos?part=snippet&chart=mostPopular&maxResults=0&regionCode=IN&key=${api_key}`
